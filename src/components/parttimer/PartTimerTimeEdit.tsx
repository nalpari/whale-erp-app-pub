export default function PartTimerTimeEdit() {
  return (
    <>
              ...
              <div className="sub-item-bx">
                <div className="data-filed">
                  <div className="block mb15">
                    <div className="s-txt">
                      근무 시간을 입력하지 않을 경우 해당 날짜는 출근하지 않은
                      날짜로 인식합니다.
                    </div>
                    <div className="s-txt">
                      총근무시간은 출근시간에서 퇴근시간까지의 모든 시간을
                      입력하세요.
                    </div>
                    <div className="s-txt">
                      휴게시간은 총근무시간에서 제외하고 급여명세서에
                      표시됩니다.
                    </div>
                    <div className="s-txt">
                      예: 총근무시간 9시간, 휴게시간 60분일 경우 8시간 근무로
                      표시됩니다.
                    </div>
                  </div>
                  ...
                  <div className="s-txt mb10">BIM1001</div>
                  <div className="block">
              ...
              <div className="sub-item-bx">
                ...
                <div className="work-time-data-wrap">
                  <div className="work-time-data-item">
                    <div className="work-time-data-item-tit">출근시간</div>
